...
import com.wsz.xiaolanshu.comment.biz.util.HeatCalculator;
 ...
 */
@Component
@RocketMQMessageListener(consumerGroup = "xiaolanshu_group_" + MQConstants.TOPIC_COMMENT_HEAT_UPDATE, // Group 组
