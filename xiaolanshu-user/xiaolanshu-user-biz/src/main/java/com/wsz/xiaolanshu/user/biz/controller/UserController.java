...
public class UserController {
    ...
    @PostMapping("/roles")
    @ApiOperationLog(description = "获取用户的角色标识集合")
    public Response<List<String>> getUserRoleKeys(@RequestParam("userId") Long userId) {
        return userService.getUserRoleKeys(userId);
    }
}
