package com.wsz.xiaolanshu.user.relation.biz.service.impl;
...
public class RelationServiceImpl implements RelationService {
    ...
    public Response<?> follow(FollowUserReqVO followUserReqVO) {
        ...
        String followingRedisKey = RedisConstants.buildUserFollowingKey(userId);
    ...
    public PageResponse<FindFollowingUserRspVO> findFollowingList(FindFollowingListReqVO findFollowingListReqVO) {
        ...
        // 先从 Redis 中查询
        String followingListRedisKey = RedisConstants.buildUserFollowingKey(userId);
