package com.wsz.xiaolanshu.user.relation.biz.consumer;
...
public class FollowUnfollowConsumer implements RocketMQListener<Message> {
    ...
    private void handleFollowTagMessage(String bodyJsonStr) {
        ...
        if (isSuccess) {
            ...
            String fansRedisKey = RedisConstants.buildUserFansKey(followUserId);
            // 执行脚本
    ...
    private void handleUnfollowTagMessage(String bodyJsonStr) {
        ...
        if (isSuccess) {
            ...
            String fansRedisKey = RedisConstants.buildUserFansKey(unfollowUserId);
            // 删除指定粉丝
