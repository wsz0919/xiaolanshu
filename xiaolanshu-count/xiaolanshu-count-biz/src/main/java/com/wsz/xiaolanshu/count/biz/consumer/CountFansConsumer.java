...
import com.wsz.xiaolanshu.count.biz.domain.dto.CountFollowUnfollowMqDTO;
import com.wsz.xiaolanshu.count.biz.enums.FollowUnfollowTypeEnum;
...
import static com.wsz.xiaolanshu.count.biz.enums.FollowUnfollowTypeEnum.FOLLOW;
import static com.wsz.xiaolanshu.count.biz.enums.FollowUnfollowTypeEnum.UNFOLLOW;

/**
 * Description
 *
 * @Author wangshaozhe
 * @Date 2026-01-28 15:27
 * @Company:
 */
@Component
@RocketMQMessageListener(consumerGroup = "xiaolanshu_group_" + MQConstants.TOPIC_COUNT_FANS, // Group 组
    ...
    private void consumeMessage(List<String> bodys) {
        ...
        countMap.forEach((k, v) -> {
            ...
            if (isExisted) {
                ...
                redisTemplate.opsForHash().increment(redisKey, RedisConstants.FIELD_FANS_TOTAL, v);
            }
        });
