 ...
 */
@Component
@RocketMQMessageListener(consumerGroup = "xiaolanshu_group_" + MQConstants.TOPIC_LIKE_OR_UNLIKE, // Group 组
    ...
    private void consumeMessage(List<String> bodys) {
        ...
        countList.forEach(item -> {
            ...
            if (isCountNoteExisted) {
                ...
                redisTemplate.opsForHash().increment(countNoteRedisKey, RedisConstants.FIELD_LIKE_TOTAL, count);
            }
