...
import com.wsz.xiaolanshu.count.biz.domain.dto.AggregationCountCollectUnCollectNoteMqDTO;
import com.wsz.xiaolanshu.count.biz.domain.dto.CountCollectUnCollectNoteMqDTO;
import com.wsz.xiaolanshu.count.biz.enums.CollectUnCollectNoteTypeEnum;
...
public class CountNoteCollectConsumer implements RocketMQListener<String> {
    ...
    private void consumeMessage(List<String> bodys) {
        ...
        countList.forEach(item -> {
            ...
            // 笔记维度计数 Redis Key
            String countNoteRedisKey = RedisConstants.buildCountNoteKey(noteId);
            ...
            if (isCountNoteExisted) {
                ...
                redisTemplate.opsForHash().increment(countNoteRedisKey, RedisConstants.FIELD_COLLECT_TOTAL, count);
            }
