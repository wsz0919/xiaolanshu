...
import com.wsz.xiaolanshu.data.align.mapper.DeleteMapper;
import com.wsz.xiaolanshu.data.align.mapper.SelectMapper;
import com.wsz.xiaolanshu.data.align.mapper.UpdateMapper;
import com.wsz.xiaolanshu.data.align.rpc.SearchRpcService;
            ...
            noteIds.forEach(noteId -> {
                ...
                if (count > 0) {
                    ...
                    if (hashKey) {
                        ...
                        redisTemplate.opsForHash().put(redisKey, RedisConstants.FIELD_LIKE_TOTAL, likeTotal);
                    }
                }
