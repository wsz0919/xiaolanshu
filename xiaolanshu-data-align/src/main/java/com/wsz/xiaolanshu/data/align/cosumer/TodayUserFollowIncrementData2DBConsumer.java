...
import com.wsz.xiaolanshu.data.align.domain.dto.FollowUnfollowMqDTO;
...
public class TodayUserFollowIncrementData2DBConsumer implements RocketMQListener<String> {
    ...
    public void onMessage(String body) {
        ...
        String userBloomKey = RedisConstants.buildBloomUserFollowListKey(date);
        ...
        String targetUserBloomKey = RedisConstants.buildBloomUserFansListKey(date);
        // 布隆过滤器判断该日增量数据是否已经记录
