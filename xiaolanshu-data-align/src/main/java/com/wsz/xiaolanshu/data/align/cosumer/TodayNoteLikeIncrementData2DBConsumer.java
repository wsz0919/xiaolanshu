...
import com.wsz.xiaolanshu.data.align.domain.dto.LikeUnlikeNoteMqDTO;
 ...
 */
@Component
@RocketMQMessageListener(consumerGroup = "xiaolanshu_group_data_align_" + MQConstants.TOPIC_COUNT_NOTE_LIKE, // Group 组
...
public class TodayNoteLikeIncrementData2DBConsumer implements RocketMQListener<String>{
    ...
    public void onMessage(String body) {
        ...
        System.out.println(tableShards);
