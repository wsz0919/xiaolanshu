...
import com.wsz.xiaolanshu.search.index.UserIndex;
...
public class UserServiceImpl implements UserService {
    ...
    public PageResponse<SearchUserRspVO> searchUser(SearchUserReqVO searchUserReqVO) {
        ...
        sourceBuilder.query(QueryBuilders.multiMatchQuery(
                keyword, UserIndex.FIELD_USER_NICKNAME, UserIndex.FIELD_USER_XIAOLANSHU_ID));
        ...
        try {
            ...
            for (SearchHit hit : hits) {
                ...
                String xiaolanshuId = (String) sourceAsMap.get(UserIndex.FIELD_USER_XIAOLANSHU_ID);
